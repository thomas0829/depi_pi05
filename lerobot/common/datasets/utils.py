...
def get_episode_data_index(
    ...
    _from = {ep_idx: 0 if i == 0 else cumulative_lengths[i - 1] for i, ep_idx in enumerate(episodes)}
    _to = {ep_idx: cumulative_lengths[i] for i, ep_idx in enumerate(episodes)}
    return {
        "from": _from,
        "to": _to,
    }, {
